...
bool adxl345_check_connection(ADXL345I2C i2c_c) {
    ...
    _adxl345_read_from_reg(i2c_c, ADXL345_ID_REGISTER_ADDR, 1, &buff);

    return buff == ADXL345_DEVICE_ID;
}

void adxl345_get_settings(ADXL345I2C i2c_c, uint8_t buff[1]) {
    _adxl345_read_from_reg(i2c_c, ADXL345_DATA_FORMAT_REGISTER_ADDR, 1, buff);
}
...
void adxl345_set_measurements_range(ADXL345I2C i2c_c,
    ...
    _adxl345_write_to_reg(i2c_c, ADXL345_DATA_FORMAT_REGISTER_ADDR,
                          settings_buff);
...
void adxl345_start_measurements(ADXL345I2C i2c_c) {
    _adxl345_write_to_reg(i2c_c, ADXL345_POWER_CONTROL_REGISTER_ADDR,
                          ADXL345_ACTIVE_MODE);
...
void adxl345_get_readings(ADXL345I2C i2c_c, float accel[3]) {
    ...
    _adxl345_read_from_reg(i2c_c, ADXL345_DATA_REGISTER_ADDR, 6, data_buff);
