...
const double ADXL345_EARTH_GRAVITY = 9.80665;
const double ADXL345_SCALE_MULTIPLIER = 0.004;
const double ADXL345_FINAL_READINGS_FACTOR =
    ADXL345_EARTH_GRAVITY * ADXL345_SCALE_MULTIPLIER;
...
void _adxl345_convert_readings(uint8_t raw_buff[6], float* accel) {
    for (int i = 0; i < 3; i++) {
        ...
        float out_f = (float)out_i * ADXL345_FINAL_READINGS_FACTOR;
